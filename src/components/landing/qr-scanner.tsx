...
export default function QrScanner() {
  return (
    <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-2xl p-4 bg-card/20 backdrop-blur-sm border-2 border-primary/30 shadow-2xl flex items-center justify-center">
